...
const $map = document.querySelector('.plan_map'),
    ...
    mapIcon = 'https://uploads-ssl.webflow.com/61268cc8812ac5956bad13e4/64b1caf7a3284e103e4fc172_pin.png', 
...
google.maps.event.addDomListener(window, 'load', () => {
    ...
    retrieveSavedMarkersFromFirebase($userMail.value);
}); 
...
!function initMap() {
    ...
    searchBox.addListener('places_changed', () => { 
        ...
        places.forEach((place) => {
            ...
            saveMarkerToFirebase($userMail.value, dayNum, markerObj);  
