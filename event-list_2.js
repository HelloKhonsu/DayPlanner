...
/*
* Setup day-events div on page
*/

/*const $body = document.body;
const $mainSection = $body.querySelector('section'); 

const $mapDiv = document.createElement('div');
$mapDiv.id = 'map';
$mainSection.append($mapDiv); 

const $dayEventsDiv = document.createElement('div');
$dayEventsDiv.className = 'day-events'; 
$mainSection.append($dayEventsDiv); 

const $dayEvent1 = document.createElement('div'); 
$dayEvent1.className = 'day-event day-1-event'; 
const $dayHead = document.createElement('div'); 
$dayHead.className = 'day-head'; 
$dayEvent1.append($dayHead); 

const $singleEvent = document.createElement('div'); 
$singleEvent.className = 'single-event hide';
$dayEvent1.append($singleEvent); 

const $eventLink = document.createElement('a');
$eventLink.href = '#';
$eventLink.className = 'event-link';
$eventLink.setAttribute('target','_blank');
$singleEvent.append($eventLink); 

$dayEventsDiv.append($dayEvent1); 
*/
...
function constructEvent(dayEventTxt, day, marker, eventNum, markerObj) {
    ...
    console.log('Inside constructEvent') 
