...
import { getFirestore, doc, setDoc, getDoc, getDocs, deleteDoc, collection } from "https://www.gstatic.com/firebasejs/10.1.0/firebase-firestore.js";
...
function removeFirebaseSavedMarker() {

}

document.querySelector('[data-wf-user-logout="Log out"]')?.addEventListener('click', () => {
